...
```bash
composer require filament-admin/filament-scaffold
```
...
```bash
use FilamentAdmin\FilamentScaffold\FilamentScaffoldPlugin;
...
```bash
php artisan vendor:publish --provider="FilamentAdmin\FilamentScaffold\FilamentScaffoldServiceProvider" --tag="filament-scaffold-config"
```
